...
class SubtasksControllerTest < ActionController::TestCase
  ...
  test "should create subtask" do
    assert_difference('Subtask.count') do
      post :create, subtask: { finished: @subtask.finished, parent_id: @subtask.parent_id, text: @subtask.text }
    end
  ...
  test "should update subtask" do
    patch :update, id: @subtask, subtask: { finished: @subtask.finished, parent_id: @subtask.parent_id, text: @subtask.text }
    assert_redirected_to subtask_path(assigns(:subtask))
  end
